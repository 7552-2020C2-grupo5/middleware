...
ns.models[new_user_review_model.name] = new_user_review_model
ns.models[reviewee_score_model.name] = reviewee_score_model
ns.models[user_review_model.name] = user_review_model
